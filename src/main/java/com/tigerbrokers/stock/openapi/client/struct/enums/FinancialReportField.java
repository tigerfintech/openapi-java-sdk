...
public enum FinancialReportField {
  ...
  incRealEstateRec("inc_real_estate_rec", 67L, 0),
  apBnk("ap_bnk", 1019L, 0),
  totalArUti("total_ar_uti", 1274L, 0),
  arUti("ar_uti", 1020L, 0),
  aeBnk("ae_bnk", 1017L, 0),
  accrIntPay("accr_int_pay", 1080L, 0),
  accrIntReceiv("accr_int_receiv", 1078L, 0),
  acquisitionReAssets("acquisition_re_assets", 2124L, 0),
  sharesPerDr("shares_per_dr", 4005L, 0),
  allowBorrowConst("allow_borrow_const", 114L, 0),
  allowEquityConst("allow_equity_const", 116L, 0),
  allowLl("allow_ll", 1081L, 0),
  allowance5YrAnnCagr("allowance_5yr_ann_cagr", 4334L, 0),
  defPolicyAmort("def_policy_amort", 2059L, 0),
  gwIntanAmortBnk("gw_intan_amort_bnk", 197L, 0),
  otherAmortBnk("other_amort_bnk", 2015L, 0),
  gwIntanAmortCfBnk("gw_intan_amort_cf_bnk", 2016L, 0),
  gwIntanAmortIns("gw_intan_amort_ins", 395L, 0),
  annuityPay("annuity_pay", 2065L, 0),
  annuityRec("annuity_rec", 2068L, 0),
  assetMgmtFee("asset_mgmt_fee", 120L, 0),
  assetWritedownBnk("asset_writedown_bnk", 33L, 0),
  doAssetsCurrent("do_assets_current", 1108L, 0),
  doAssetsLt("do_assets_lt", 1192L, 0),
  avgIntBearLiab5YrAnnCagr("avg_int_bear_liab_5yr_ann_cagr", 4339L, 0),
  avgIntEarnAssets5YrAnnCagr("avg_int_earn_assets_5yr_ann_cagr", 4338L, 0),
  brokCommission("brok_commission", 125L, 0),
  capexBnk("capex_bnk", 2114L, 0),
  cashSegreg("cash_segreg", 1235L, 0),
  changeApBnk("change_ap_bnk", 2066L, 0),
  changeArBnk("change_ar_bnk", 2067L, 0),
  changeInsResLiab("change_ins_res_liab", 2095L, 0),
  changeOtherNetOperAssetsBnk("change_other_net_oper_assets_bnk", 2140L, 0),
  accrIntPayCf("accr_int_pay_cf", 2060L, 0),
  accrIntReceivCf("accr_int_receiv_cf", 2061L, 0),
  commissFees("commiss_fees", 128L, 0),
  commonApicBnk("common_apic_bnk", 1280L, 0),
  compBenefits("comp_benefits", 366L, 0),
  otherEquityBnk("other_equity_bnk", 1022L, 0),
  nukeContr("nuke_contr", 2108L, 0),
  costService("cost_service", 37L, 0),
  creditCardFeeBnk("credit_card_fee_bnk", 126L, 0),
  currencyGainIns("currency_gain_ins", 39L, 0),
  currentPortDebtBnk("current_port_debt_bnk", 1024L, 0),
  currentPortBnk("current_port_bnk", 1278L, 0),
  defChargesCf("def_charges_cf", 2079L, 0),
  defChargesLtBnk("def_charges_lt_bnk", 1112L, 0),
  defPolicyAcqCosts("def_policy_acq_costs", 1115L, 0),
  defPolicyAcqCostsCf("def_policy_acq_costs_cf", 2082L, 0),
  defTaxAssetsLtBnk("def_tax_assets_lt_bnk", 1118L, 0),
  defTaxLiabLtBnk("def_tax_liab_lt_bnk", 1120L, 0),
  depositsFin("deposits_fin", 1277L, 0),
  daSupplIns("da_suppl_ins", 135L, 0),
  daIns("da_ins", 376L, 0),
  daSupplCfBnk("da_suppl_cf_bnk", 2002L, 0),
  distrExcessEarn("distr_excess_earn", 1114L, 0),
  ebtExclBnk("ebt_excl_bnk", 5L, 0),
  extraAccItemsBnk("extra_acc_items_bnk", 43L, 0),
  fdic("fdic", 160L, 0),
  fhlbDebt("fhlb_debt", 1165L, 0),
  fuel("fuel", 411L, 0),
  gainAssetsRevBnk("gain_assets_rev_bnk", 55L, 0),
  gainAssetsBnk("gain_assets_bnk", 57L, 0),
  gainAssetsRevIns("gain_assets_rev_ins", 105L, 0),
  gainInvestRevBnk("gain_invest_rev_bnk", 61L, 0),
  gainInvestBnk("gain_invest_bnk", 60L, 0),
  gainInvestRevIns("gain_invest_rev_ins", 107L, 0),
  gainLoansReceiv("gain_loans_receiv", 2091L, 0),
  gainLoansReceivRevFin("gain_loans_receiv_rev_fin", 108L, 0),
  gainLoansRev("gain_loans_rev", 196L, 0),
  grossLoans("gross_loans", 1188L, 0),
  grossLoans5YrAnnCagr("gross_loans_5yr_ann_cagr", 4333L, 0),
  incEquityRevBnk("inc_equity_rev_bnk", 152L, 0),
  incEquityIns("inc_equity_ins", 48L, 0),
  incRealEstateRev("inc_real_estate_rev", 68L, 0),
  incTradeAct("inc_trade_act", 337L, 0),
  instDeposits("inst_deposits", 1245L, 0),
  insAnnuityLiab("ins_annuity_liab", 1037L, 0),
  insSettleBnk("ins_settle_bnk", 74L, 0),
  intIncFin("int_inc_fin", 109L, 0),
  intIncUti("int_inc_uti", 66L, 0),
  intInvIncUti("int_inv_inc_uti", 111L, 0),
  intBearingDeposits("int_bearing_deposits", 1091L, 0),
  intExpTotal("int_exp_total", 24L, 0),
  intExpIns("int_exp_ins", 13L, 0),
  intIncInvest("int_inc_invest", 76L, 0),
  intIncLoans("int_inc_loans", 212L, 0),
  mortIntInc("mort_int_inc", 215L, 0),
  intIncTotal("int_inc_total", 25L, 0),
  intDeposits("int_deposits", 205L, 0),
  inventoryUti("inventory_uti", 1179L, 0),
  ltInvestRe("lt_invest_re", 1176L, 0),
  investDebt("invest_debt", 1175L, 0),
  investEquityPref("invest_equity_pref", 1039L, 0),
  investFhlb("invest_fhlb", 1167L, 0),
  investSecurityCfBnk("invest_security_cf_bnk", 2028L, 0),
  investRealEstate("invest_real_estate", 1181L, 0),
  investSecurity("invest_security", 1044L, 0),
  commonIssuedBnk("common_issued_bnk", 2159L, 0),
  prefIssuedBnk("pref_issued_bnk", 2174L, 0),
  developLand("develop_land", 1184L, 0),
  legalSettleBnk("legal_settle_bnk", 78L, 0),
  loanServiceRev("loan_service_rev", 237L, 0),
  loanLeaseReceiv("loan_lease_receiv", 1045L, 0),
  loansReceivLtUti("loans_receiv_lt_uti", 1191L, 0),
  ltDebtBnk("lt_debt_bnk", 1193L, 0),
  ltInvestFin("lt_invest_fin", 1038L, 0),
  ltInvestUti("lt_invest_uti", 1194L, 0),
  mergerRestructureBnk("merger_restructure_bnk", 367L, 0),
  minorityInterestBnk("minority_interest_bnk", 1053L, 0),
  mortSecurity("mort_security", 1051L, 0),
  mortBankingFee("mort_banking_fee", 241L, 0),
  mortLoans("mort_loans", 1197L, 0),
  changeDepositAcct("change_deposit_acct", 2078L, 0),
  netInterestExpUti("net_interest_exp_uti", 369L, 0),
  netIntIncBnk("net_int_inc_bnk", 17L, 0),
  netIntIncFin("net_int_inc_fin", 370L, 0),
  netIntInc5YrAnnCagr("net_int_inc_5yr_ann_cagr", 4330L, 0),
  netLoans("net_loans", 1003L, 0),
  netLoans5YrAnnCagr("net_loans_5yr_ann_cagr", 4335L, 0),
  nuke("nuke", 1200L, 0),
  acquireRealEstateCf("acquire_real_estate_cf", 2009L, 0),
  nonIntExp("non_int_exp", 26L, 0),
  nonIntInc5YrAnnCagr("non_int_inc_5yr_ann_cagr", 4331L, 0),
  nonIntInc("non_int_inc", 27L, 0),
  nonOperExp("non_oper_exp", 84L, 0),
  nonOperInc("non_oper_inc", 255L, 0),
  nonPerfAssets5YrAnnCagr("non_perf_assets_5yr_ann_cagr", 4337L, 0),
  nonPerfLoans5YrAnnCagr("non_perf_loans_5yr_ann_cagr", 4336L, 0),
  nonInsExp("non_ins_exp", 247L, 0),
  nonInsRev("non_ins_rev", 248L, 0),
  nonIntBearingDeposits("non_int_bearing_deposits", 1092L, 0),
  loansReceivCurrent("loans_receiv_current", 1190L, 0),
  nukeCf("nuke_cf", 2109L, 0),
  occupyExp("occupy_exp", 250L, 0),
  operIncUti("oper_inc_uti", 22L, 0),
  operIncIns("oper_inc_ins", 356L, 0),
  operationsExp("operations_exp", 278L, 0),
  otherAdjustGrossLoans("other_adjust_gross_loans", 1208L, 0),
  otherAssetsBnk("other_assets_bnk", 1273L, 0),
  otherCaUti("other_ca_uti", 1266L, 0),
  otherCaSupplBnk("other_ca_suppl_bnk", 1056L, 0),
  otherClSupplBnk("other_cl_suppl_bnk", 1058L, 0),
  otherClSupplIns("other_cl_suppl_ins", 1202L, 0),
  otherClUti("other_cl_uti", 1271L, 0),
  otherFinanceActBnk("other_finance_act_bnk", 2176L, 0),
  otherFinanceActSupplBnk("other_finance_act_suppl_bnk", 2049L, 0),
  otherIntanBnk("other_intan_bnk", 1041L, 0),
  otherInvestActBnk("other_invest_act_bnk", 2178L, 0),
  otherInvestActSupplBnk("other_invest_act_suppl_bnk", 2048L, 0),
  otherLiabBnk("other_liab_bnk", 1268L, 0),
  otherLtAssetsBnk("other_lt_assets_bnk", 1061L, 0),
  otherLiabLtBnk("other_liab_lt_bnk", 1205L, 0),
  otherLiabLtUti("other_liab_lt_uti", 1063L, 0),
  otherNonIntExpTotal("other_non_int_exp_total", 377L, 0),
  otherNonOperExpIns("other_non_oper_exp_ins", 372L, 0),
  otherNonOperExpSupplIns("other_non_oper_exp_suppl_ins", 86L, 0),
  otherOperActBnk("other_oper_act_bnk", 2046L, 0),
  otherOperTotBnk("other_oper_tot_bnk", 2180L, 0),
  otherOperSupplIns("other_oper_suppl_ins", 89L, 0),
  otherOperIns("other_oper_ins", 361L, 0),
  otherRealEstate("other_real_estate", 1207L, 0),
  otherReceivIns("other_receiv_ins", 1064L, 0),
  otherRevIns("other_rev_ins", 358L, 0),
  otherRevSupplIns("other_rev_suppl_ins", 91L, 0),
  otherUnusualSupplBnk("other_unusual_suppl_bnk", 88L, 0),
  otherUnusualBnk("other_unusual_bnk", 375L, 0),
  policyCost("policy_cost", 36L, 0),
  policyBenefits("policy_benefits", 94L, 0),
  policyLoans("policy_loans", 1211L, 0),
  prefOtherBnk("pref_other_bnk", 1066L, 0),
  premiumsAnnuityRev("premiums_annuity_rev", 63L, 0),
  propertyExp("property_exp", 35L, 0),
  propertyMgmtFee("property_mgmt_fee", 244L, 0),
  ll("ll", 359L, 0),
  pll("pll", 277L, 0),
  provision5YrAnnCagr("provision_5yr_ann_cagr", 4332L, 0),
  saleIntanCfBnk("sale_intan_cf_bnk", 2030L, 0),
  realEstate("real_estate", 1223L, 0),
  regAssets("reg_assets", 1220L, 0),
  reinsurance("reinsurance", 294L, 0),
  reinsurPay("reinsur_pay", 1067L, 0),
  reinsurPayCf("reinsur_pay_cf", 2121L, 0),
  reinsurRecoverCf("reinsur_recover_cf", 2122L, 0),
  reinsurRecover("reinsur_recover", 1068L, 0),
  rentalRev("rental_rev", 334L, 0),
  commonRepBnk("common_rep_bnk", 2165L, 0),
  prefRepBnk("pref_rep_bnk", 2170L, 0),
  restructureCf("restructure_cf", 2120L, 0),
  restructureBnk("restructure_bnk", 99L, 0),
  revUti("rev_uti", 410L, 0),
  revBeforeLl("rev_before_ll", 360L, 0),
  salary("salary", 153L, 0),
  saleRealEstateCfBnk("sale_real_estate_cf_bnk", 2123L, 0),
  securReceiv("secur_receiv", 2126L, 0),
  saleReAssets("sale_re_assets", 2125L, 0),
  securityBorrow("security_borrow", 1234L, 0),
  securityOwn("security_own", 1236L, 0),
  secPurchasedResell("sec_purchased_resell", 1240L, 0),
  sgaBnk("sga_bnk", 103L, 0),
  separateAcctAssets("separate_acct_assets", 1230L, 0),
  separateAcctLiab("separate_acct_liab", 1231L, 0),
  servChargeDeposits("serv_charge_deposits", 298L, 0),
  sva("sva", 4276L, 0),
  stInvestUti("st_invest_uti", 1242L, 0),
  stDebtBnk("st_debt_bnk", 1047L, 0),
  tenant("tenant", 293L, 0),
  assetWritedownCfBnk("asset_writedown_cf_bnk", 2020L, 0),
  totalDebtIssuedBnk("total_debt_issued_bnk", 2162L, 0),
  totalDebtRepaidBnk("total_debt_repaid_bnk", 2163L, 0),
  totalDeposits("total_deposits", 1010L, 0),
  totalDeposits5YrAnnCagr("total_deposits_5yr_ann_cagr", 45873L, 0),
  daCfBnk("da_cf_bnk", 2185L, 0),
  totalEquity5YrAnnCagr("total_equity_5yr_ann_cagr", 4340L, 0),
  intDivInc("int_div_inc", 64L, 0),
  intBorrow("int_borrow", 11L, 0),
  totalInvest("total_invest", 1011L, 0),
  totalLiabBnk("total_liab_bnk", 1012L, 0),
  mergerBnk("merger_bnk", 81L, 0),
  mortBankAct("mort_bank_act", 79L, 0),
  totalOperExpIns("total_oper_exp_ins", 364L, 0),
  otherInvest("other_invest", 1059L, 0),
  otherNonIntExp("other_non_int_exp", 92L, 0),
  otherNonIntInc("other_non_int_inc", 93L, 0),
  realEstateAssets("real_estate_assets", 1015L, 0),
  totalRevBnk("total_rev_bnk", 365L, 0),
  totalRevIns("total_rev_ins", 29L, 0),
  tradePrincipal("trade_principal", 290L, 0),
  treasuryOtherEquityBnk("treasury_other_equity_bnk", 1283L, 0),
  trustInc("trust_inc", 338L, 0),
  trustPref("trust_pref", 1071L, 0),
  invBankingFee("inv_banking_fee", 199L, 0),
  unearnPremium("unearn_premium", 1252L, 0),
  unearnRevCurrentBnk("unearn_rev_current_bnk", 1255L, 0),
  unpaidClaims("unpaid_claims", 1073L, 0),
  creditCardFee("credit_card_fee", 362L, 0),
  longTermDebtIssued("long_term_debt_issued", 2035L, 0),
  longTermDebtRepaid("long_term_debt_repaid", 2037L, 0),
  netDecreaseLoansOriginated("net_decrease_loan_originated", 2103L, 0),
  sellPPE("sell_ppe", 2130L, 0),
  shortTermDebtIssuedCollected("short_term_debt_issued_collected", 2131L, 0),
  shortTermDebtRepaidCollected("short_term_debt_repaid_collected", 2132L, 0),
  shortTermBorrowings("short_term_borrowings", 1189L, 0),
  customReturnOnAssets("custom_return_on_assets", -1L, 0),
  tevToLtmTotalRevenues("tev_to_ltm_total_revenues", 100061L, 2),
  tevToLtmEbitda("tev_to_ltm_ebitda", 100063L, 2),
  tevToLtmEbit("tev_to_ltm_ebit", 100062L, 2),
  marketCapToLtmTotalRevenues("market_cap_to_ltm_total_revenues", 100064L, 2),
  marketCapToLtmEbtExclUnusualItems("market_cap_to_ltm_ebt_excl_unusual_items", 100065L, 2),
  tevToLtmUnleveredFcf("tev_to_ltm_unlevered_fcf", 102334L, 2),
  marketCapToLtmLeveredFcf("market_cap_to_ltm_levered_fcf", 102336L, 2),
  totalEnterpriseValue("total_enterprise_value", 100060L, 2),
  marketCapitalization("market_capitalization", 100054L, 2),
  sharesOutstanding("shares_outstanding", 100053L, 2);
